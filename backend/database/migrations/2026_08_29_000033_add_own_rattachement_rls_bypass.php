...
/**
 * Traduction directe de db/migrations/024_own_rattachement_rls_bypass.sql.
 */
...
SQL
    ...
    {
        DB::statement('DROP POLICY IF EXISTS own_rattachement_visible ON etablissement_utilisateurs;');
    }
};
