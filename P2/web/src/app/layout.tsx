...
// Accent manuscrit — uniquement la tagline "Apprendre aujourd'hui, bâtir
// demain." sur l'accueil (maquette validée) ; jamais pour du texte
// fonctionnel, seulement une touche éditoriale.
const caveat = Caveat({
  subsets: ['latin', 'latin-ext'],
  weight: ['600'],
  variable: '--font-hand',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="fr">
      <body className={`${outfit.className} ${caveat.variable} bg-sand flex flex-col min-h-screen`}>
        ...
        <Navbar />
        <main id="contenu" className="max-w-6xl mx-auto px-4 py-8 flex-1 w-full">{children}</main>
        <Footer />
